...
5400억개의 매개 변수, densely activated, [transformer](/docs/machine-learning/deep-learning/attention-is-all-you-need) 언어 모델인 Pathways Language Model(PaLM)을 학습시켰습니다.
...
PaLM은 표준 [transformer](/docs/machine-learning/deep-learning/attention-is-all-you-need) 아키텍처에서 디코더만 있는 설정을 사용했고
