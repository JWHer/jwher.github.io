...
[다음 글](/docs/infrastructure/kubernetes/kubernetes-architecture)에서 **어떻게** 쿠버네티스가 세가지 문제를 해결하는지 알아봅시다!
...
## 그래서 어떻게 작동하는데?
[다음 글](/docs/infrastructure/kubernetes/kubernetes-architecture)에서 쿠버네티스 구성요소와 작동방식을 이어서 설명합니다.  
