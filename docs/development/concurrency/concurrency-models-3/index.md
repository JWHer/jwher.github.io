...
[day1](/docs/development/concurrency/concurrency-models-2) 에서 살펴본 “dining philosophers”를 봅시다.
...
[day 1](/docs/development/concurrency/concurrency-models-2#our-first-lock)에서 `increment()` 메서드에 동기화를 사용해 멀티스레드 카운터를 고정시켰습니다.
...
이 클래스는 [day3](/docs/development/concurrency/concurrency-models-4)에서 다룹니다.
