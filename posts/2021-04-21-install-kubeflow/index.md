...
[쿠브플로우 역할](/posts/welcome-to-kubeflow/) 을 정확히 이해하고 목적에 맞는 배포판을 설치하는 것을 추천합니다.
...
[나에게 필요한 쿠버네티스 설치하기](/posts/install-kubernetes)
...
쿠버네티스가 없으신 분은 [이글](/posts/install-kubernetes/) 설치법을 참고해주세요.  
...
kubernetes 저사양 node 등에 맞춰 다양한 버전이 있습니다. [이글](/posts/install-kubernetes/)
