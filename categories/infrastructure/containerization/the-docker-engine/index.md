...
[![the docker engine](/img/logos/docker.svg)](/categories/infrastructure/containerization/the-docker-engine/the-docker-engine)  
*The Docker Engine*  
...
이 계획은 작은 특화된 도구를 같이 모아 큰 도구를 만들 수 있다는 시도해왔고 검증된 [유닉스 철학](/categories/infrastructure/kubernetes/welcome-to-kubernetes/welcome-to-kubernetes#unix-철학)을 따릅니다.
