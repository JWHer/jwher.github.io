...
설마 kubectl이 없을까요...?  
쿠버네티스를 처음 접하신다면 쿠버네티스 구조를 다룬 [이글](/categories/infrastructure/kubernetes/welcome-to-kubernetes/welcome-to-kubernetes)
먼저 보시는걸 추천합니다.
...
개념 이해에 도움이 되는 글입니다  
[쿠버네티스 개념](/categories/infrastructure/kubernetes/welcome-to-kubernetes/welcome-to-kubernetes)  
[쿠버네티스 아키텍처](/categories/infrastructure/kubernetes/kubernetes-architecture/kubernetes-architecture)
