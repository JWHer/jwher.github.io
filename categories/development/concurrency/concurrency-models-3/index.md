...
[![concurrency](icing.jpeg)](/categories/development/concurrency/concurrency-models-3)  
...
[day1](/categories/development/concurrency/concurrency-models-2) 에서 살펴본 “dining philosophers”를 봅시다.
...
[day 1](/categories/development/concurrency/concurrency-models-2#our-first-lock)에서 `increment()` 메서드에 동기화를 사용해 멀티스레드 카운터를 고정시켰습니다.
...
이 클래스는 [day3](/categories/development/concurrency/concurrency-models-4)에서 다룹니다.

<details>
<summary>Volatile은 어떤가요?</summary>

자바는 변수를 *volatile*로 표시해 읽고 쓰는 순서가 바뀌지 않게 보장합니다.
[`Puzzle`](/categories/development/concurrency/concurrency-models-2/#-mysterious-memory)의 `answerReady`를 volatile로 만들어 해결할 수 있습니다.
