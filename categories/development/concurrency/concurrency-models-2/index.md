...
[![concurrency](ford-model-t.jpeg)](/categories/development/concurrency/concurrency-models-2/concurrency-models-2)  
...
[(이후에 `java.util.concurrent.atomic` 패키지가 락을 사용하는 대신 좋은 대안을 제공하는것을 보입니다)](/categories/development/concurrency/concurrency-models-3/concurrency-models-3#atomic-variables)
